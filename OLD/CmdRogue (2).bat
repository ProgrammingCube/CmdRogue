...
echo.    пллл                         пллп      плл
echo.
ctext.exe "{04}          Console Roguelike {0c}v.0.0.0.3{0a}{{a}"
echo.
...
echo.
echo.
echo  Add. coding  : ChristianXD, kolt101, Charlie Nash
echo                 Ethan Brooks
...
call :Monster_Move
goto Monsters_1
::it doesn't work right because the monsters are shown after ALL the loops have been executed.
::I need to figure out how to fixate each monster before moving on to the next.

::The last monster (monsterN) dies first still, but the monster you're going to kill dies right when you do.
